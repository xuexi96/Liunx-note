...
[Service]
# 设置工作命令
WorkingDirectory=/usr/trojan 
Type=simple
# 运行命令
ExecStart=/usr/trojan/trojan-go -config /usr/trojan/config.json
# 日志
StandardOutput=append:/usr/trojan/trojan.log 
StandardError=append:/usr/trojan/trojan.log
Restart=on-failure
RestartSec=5
LimitNOFILE=65535
